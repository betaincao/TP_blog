        ...
        <div class="content_resize">
            <div class="mainbar">
                <div class="article">
                    ...
                    <?php if(is_array($article_list)): $i = 0; $__LIST__ = $article_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><div class="blogs">
                            <h3><a href="/index.php?c=article&a=show&a_id=<?php echo ($list["a_id"]); ?>"><?php echo ($list["a_title"]); ?></a></h3>
                            <figure><img src="<?php echo ($list["a_photo"]); ?>" width="100" height="100"></figure>
                            <?php echo ($list["a_begin"]); ?>
                            <a href="/index.php?c=article&a=show&a_id=list.a_id"
                               class="readmore">阅读全文&gt;&gt;</a>
                            <p class="autor"><span>作者：<?php echo ($list["a_adduser"]); ?></span><span>分类：【<a href="/"><?php echo ($list["a_type"]); ?></a>】
                                </span><span>浏览（<?php echo ($list["a_visit"]); ?>） </span><span>评论（<?php echo ($list["a_comment"]); ?>） </span>
                                <span>发布时间：<?php echo ($list["a_addtime"]); ?></span></p>
                            <div class="dateview" align="center"><?php echo ($list["a_addtime"]); ?></div>
            ...
            <div class="sidebar">
                <div class="searchform">
                    <form id="formsearch" name="formsearch" method="post" action=""><span><input
                            ...
                            name="button_search" src="/Public/home/images/search_btn.gif" class="button_search"
                            type="image"/></form>
                </div>
                <div class="gadget">
